...
def options(opt):
    ...
    optgrp.add_option('--with-power-optimize', action='store_true', default=False,
                      help='/Run power-optimized mode')
