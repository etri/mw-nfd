...
#endif
				if( !strcmp(host, addr) ){
					//std::cout << addr << " - ifIndex:" <<  if_nametoindex(ifa->ifa_name) << std::endl;
					return if_nametoindex(ifa->ifa_name);
				}
			}
		}
