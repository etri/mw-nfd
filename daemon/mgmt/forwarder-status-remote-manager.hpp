/* -*- M/de:C++; c-file-style:"gnu"; indent-tabs-mode:nil; -*- */
/*
...
#ifndef NFD_DAEMON_MGMT_FORWARDER_STATUS_REMOTE_MANAGER_HPP
#define NFD_DAEMON_MGMT_FORWARDER_STATUS_REMOTE_MANAGER_HPP
 ...
 */
class ForwarderStatusRemoteManager : noncopyable
{
public:
  ForwarderStatusRemoteManager(Forwarder& forwarder, Dispatcher& dispatcher, FaceSystem& faceSystem);
